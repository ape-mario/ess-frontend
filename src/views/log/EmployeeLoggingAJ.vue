    ...
    <v-container style="color: #2c3e50; width: 100%; min-width: 100%">
      <v-row class="align-center justify-space-between mb-4">
        ...
        <v-col cols="6" class="d-flex align-center">
          <span class="text-h3 font-weight-semibold">Employee Logging AJ</span>
        </v-col>
          ...
          <v-card-text>
            <v-container>
              <v-row>
                ...
                <v-col cols="6">
                  <v-text-field v-model="form.spv" label="SPV Assigned" variant="solo-filled" dense bg-color="#F8FAFB"></v-text-field>
                </v-col>
...
const headers = [
  ...
  { title: 'SPV Assigned', key: 'spv' },
  { title: 'Activity Detail', key: 'activity' },
  { title: 'Collaboration With', key: 'collab' },
